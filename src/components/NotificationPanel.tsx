...
const NotificationPanel: React.FC = () => {
  ...
  const fetchNotifications = async () => {
    setLoading(true);
    const res = await fetch('/api/notifications/history', { headers: { Authorization: `Bearer ${token}` } });
  ...
  const markAsRead = async (id: number) => {
    ...
    await fetch(`/api/notifications/history/${id}/read`, { method: 'PUT', headers: { Authorization: `Bearer ${token}` } });
  ...
  const deleteNotification = async (id: number) => {
    ...
    setTimeout(async () => {
      await fetch(`/api/notifications/history/${id}`, { method: 'DELETE', headers: { Authorization: `Bearer ${token}` } });
  ...
  const markAllAsRead = async () => {
    ...
    await fetch('/api/notifications/history/mark-all-read', { method: 'PUT', headers: { Authorization: `Bearer ${token}` } });
  ...
  const deleteAll = async () => {
    ...
    setActionLoading(true);
    await fetch('/api/notifications/history/delete-all', { method: 'DELETE', headers: { Authorization: `Bearer ${token}` } });
