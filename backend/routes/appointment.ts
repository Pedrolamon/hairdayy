...
// Rota para listar agendamentos. Apenas barbeiros podem ver seus próprios agendamentos,
// ou agendamentos de clientes específicos.
router.get('/', authenticateJWT, async (req: AuthRequest, res: Response) => {
  try {
    // Busca o usuário logado para obter o barberId.
